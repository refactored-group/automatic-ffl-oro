...
class ShoppingListController extends AbstractController
{
    ...
    public function viewAction(ShoppingList $shoppingList = null): array
    {
        ...
        $isFFLEnabled = $this->get(AutoFFLIntegrationProvider::class)->isFFLEnabled();
        $hasMixedProducts = $this->get(AutoFFLIntegrationProvider::class)->hasMixedProductsInShoppingList($shoppingList);

        if ($isFFLEnabled && $hasMixedProducts) {
            $this->addFlash(
                'warning',
                $this->get(TranslatorInterface::class)->trans('refactored_group.automatic_ffl.checkout.condition.has_mixed_products_in_shopping_list.message')
            );
        }
    ...
    public static function getSubscribedServices()
    {
        return array_merge(parent::getSubscribedServices(), [
            AutoFFLIntegrationProvider::class,
